...
const regions = [
  {
    ...
    to: '/hong_kong_island',
    districts: [
      { key: 'central', label: (lang) => LABELS[lang].central, to: '/carparkinfo/Central%20&%20Western' },
      { key: 'wanchai', label: (lang) => LABELS[lang].wanchai, to: '/carparkinfo/Wan%20Chai' },
      { key: 'eastern', label: (lang) => LABELS[lang].eastern, to: '/carparkinfo/Eastern' },
      { key: 'southern', label: (lang) => LABELS[lang].southern, to: '/carparkinfo/Southern' },
    ],
  },
  {
    key: 'kowloon',
    ...
    to: '/kowloon',
    districts: [
      { key: 'ytm', label: (lang) => LABELS[lang].ytm, to: '/carparkinfo/Yau%20Tsim%20Mong' },
      { key: 'ssp', label: (lang) => LABELS[lang].ssp, to: '/carparkinfo/Sham%20Shui%20Po' },
      { key: 'kc', label: (lang) => LABELS[lang].kc, to: '/carparkinfo/Kowloon%20City' },
      { key: 'wts', label: (lang) => LABELS[lang].wts, to: '/carparkinfo/Wong%20Tai%20Sin' },
      { key: 'kt', label: (lang) => LABELS[lang].kt, to: '/carparkinfo/Kwun%20Tong' },
    ],
  },
  {
    key: 'nt',
    ...
    to: '/new_territories',
    districts: [
      { key: 'kts', label: (lang) => LABELS[lang].kts, to: '/carparkinfo/Kwai%20Tsing' },
      { key: 'tw', label: (lang) => LABELS[lang].tw, to: '/carparkinfo/Tsuen%20Wan' },
      { key: 'yl', label: (lang) => LABELS[lang].yl, to: '/carparkinfo/Yuen%20Long' },
      { key: 'tm', label: (lang) => LABELS[lang].tm, to: '/carparkinfo/Tuen%20Mun' },
      { key: 'north', label: (lang) => LABELS[lang].north, to: '/carparkinfo/North' },
      { key: 'tp', label: (lang) => LABELS[lang].tp, to: '/carparkinfo/Tai%20Po' },
      { key: 'st', label: (lang) => LABELS[lang].st, to: '/carparkinfo/Sha%20Tin' },
      { key: 'sk', label: (lang) => LABELS[lang].sk, to: '/carparkinfo/Sai%20Kung' },
      { key: 'islands', label: (lang) => LABELS[lang].islands, to: '/carparkinfo/Islands' },
    ],
  },
];
